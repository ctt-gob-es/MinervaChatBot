<template>
  <div :id="message.id" class="sc-message mx-6">
    <div
    ...
    >
      <div v-if="message?.data?.text" name="user-avatar" :message="message" :user="user" class="container-avatar">
        <div
      ...
      <TextMessage
        v-if="message.type === 'text' && message?.data?.text"
        :message="message"
      ...
      <FileMessage v-else-if="message.type === 'file'" :data="message.data" :message-colors="messageColors"/>
      <TypingMessage v-else-if="message.type === 'typing'" :message-colors="messageColors" />
      <SystemMessage v-else-if="message.type === 'system'" :data="message.data" :message-colors="messageColors">
        <slot name="system-message-body" :message="message.data"> </slot>
      </SystemMessage>
      <MessageButtons
        v-if="message.type === 'text_buttons'"
        :message="message"
...
import MessageButtons from './messages/MessageButtons.vue'

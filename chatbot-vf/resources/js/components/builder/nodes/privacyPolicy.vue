<template>
  <div ref="el" class="node-privacy-policy">
    <div class="title-box"> Política de privacidad</div>
    <div class="box text-center">
      ...
      <div class="d-flex flex-column">
        <v-btn class="mx-3 my-1" color="success">Estoy de acuerdo</v-btn>
        <v-btn class="mx-3 my-1" color="success">No</v-btn>
      </div>
    </div>
  </div>
</template>
...
watch(()=>bus.value.get('PrivacyPolicy'), (val) => {
})

<template>
  <div ref="el">
    <div class="title-box"><i class=""></i> Consulta resuelta</div>
    <div class="box text-center">
      ...
      <div class="d-flex flex-column">
        <v-btn class="mx-3 my-1" color="success">Si</v-btn>
...
const typeNode = 'validate_response';
const el = ref(null);
const nodeId = ref(0);
const dataNode = ref({});
...
watch(()=>bus.value.get('ValidateResponse'), (val) => {
})

...
$(document).ready(function () {
  ...
  window.deleteConversation = function (userId) {
    $.ajax({
      ...
      success: function success(data) {
        ...
        fireSwal('success', 'Eliminado', '¡La conversación ha sido eliminada!');
  ...
  $(document).on('click', '.chat__person-box-archive', function (e) {
    ...
    var ArchiveUnarchive = isArchiveChat ? 'Desarchivar' : 'Archivar';
    swalDelete.fire({
      title: '¿Estás seguro?',
      html: ArchiveUnarchive + ' chat con el usuario <b>' + contactName + '</b>?',
      icon: 'warning',
      showCancelButton: true,
      ...
      success: function success(data) {
        if (data.success === true) {
          if (data.data.archived) {
            fireSwal('success', 'Archivada', 'La conversación ha sido archivada');
          } else {
            fireSwal('success', 'Desarchivada!', 'La conversación ha sido desarchivada');
          }
          ...
          if (data.data.archived) {
            ...
            if ($('#loadMoreConversationBtn.active').length > 0) {
              $('#loadMoreConversationBtn.active').before(_archiveConversation);
            } else {
